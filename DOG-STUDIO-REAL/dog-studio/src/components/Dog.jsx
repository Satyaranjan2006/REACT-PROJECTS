...
//we need to register the plugin in order to use it
...
const Dog = () => {
  ...
  const model = useGLTF('/modules/dog.drc.glb')
  ...
  useGSAP(()=>{
   ...
   .to(dogModel.current.scene.position,{
    ...
    useEffect(() =>{
      ...
      document.querySelector(`.title[img-title="NavyPier"]`).addEventListener('mouseenter',()=>{
      ...
      document.querySelector(`.title[img-title="lousis-phone"]`).addEventListener('mouseenter',()=>{
      ...
      document.querySelector(`.title[img-title="kennedy-centre"]`).addEventListener('mouseenter',()=>{
         material.current.uMatcap1.value=mat8
        gsap.to(material.current.uProgress,{
          value:0.0,
          duration:0.3,
      ...
      document.querySelector(`.title[img-title="cases"]`).addEventListener('mouseenter',()=>{
         material.current.uMatcap1.value=mat8
        gsap.to(material.current.uProgress,{
          value:0.0,
          duration:0.3,
