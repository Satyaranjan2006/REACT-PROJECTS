    ...
    <>
      <main>
        <div className="images">
          ...
          <img id='lousis-phone' src="/lousis-phone.png" alt="" />
          <img id='kikk' src="/kikk.png" alt="" />
          <img id='kennedy-centre' src="/kennedy-centre.png" alt="" />
          <img id='cases' src="/cases.png" alt="" />
        ...
        <section id='section-1'>
          ...
          <div className="middle">
            <div className="left">
              <h1>WE <br /> Make <br /> Good <br /> Shift</h1>
            </div>
        ...
        <section id='section-2'>
          <div className="titles">
            ...
            <div img-title='lousis-phone' className="title">
              <small>2020-ONGOING</small>
            ...
            <div img-title='kennedy-centre' className="title">
              <small>2020-ONGOING</small>
              <h1>The Kennedy Center</h1>
            </div>

            <div img-title='cases' className="title">
              <small>2020-ONGOING</small>
        ...
        <section id='section-3'>
          ...
          {/* <div className="bottom">
            <div className="left"></div>
            <div className="right">
              <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aspernatur necessitatibus numquam, molestiae corrupti voluptates saepe. Voluptatem eos quasi illo ad dolore reprehenderit dicta odit blanditiis cupiditate alias eaque reiciendis nihil culpa, sunt facere quidem enim molestias assumenda nesciunt. Reiciendis officiis minus accusamus quia eveniet! Nulla minima laudantium illo sint impedit.</p>
               <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aspernatur necessitatibus numquam, molestiae corrupti voluptates saepe. Voluptatem eos quasi illo ad dolore reprehenderit dicta odit blanditiis cupiditate alias eaque reiciendis nihil culpa, sunt facere quidem enim molestias assumenda nesciunt. Reiciendis officiis minus accusamus quia eveniet! Nulla minima laudantium illo sint impedit.</p>
            </div>
          </div> */}
        </section>
